<?php
/**
 * @version $Id: mi_aecautomaticsurcharge.php
 * @package AEC - Account Control Expiration - Membership Manager
 * @subpackage Micro Integrations - Automatic Surcharge MI
...
class mi_aecautomaticsurcharge
{
	...
	{
		$info = array();
		$info['name'] = JText::_('AEC_MI_AECAUTOMATICSURCHARGE_NAME');
		$info['desc'] = JText::_('AEC_MI_AECAUTOMATICSURCHARGE_DESC');
	...
	function Settings()
	{
		...
		$modes = array();
		$modes[] = JHTML::_('select.option', 'basic', JText::_('MI_MI_AECAUTOMATICSURCHARGE_SET_MODE_BASIC') );
		$modes[] = JHTML::_('select.option', 'percentage', JText::_('MI_MI_AECAUTOMATICSURCHARGE_SET_MODE_PERCENTAGE') );
