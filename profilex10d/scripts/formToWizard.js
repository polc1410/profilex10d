...
(function($) {
    $.fn.formToWizard = function( options, cmdParam1 ) {
        ...
        function createPrevButton(i) {
            var stepName = "step" + i;
            $("#" + stepName + "commands").append("<a href='#' id='" + stepName + "Prev' class='readon'><span>" + options.prevBtnName + "</span></a>");
        ...
        function createNextButton(i) {
            var stepName = "step" + i;
            $("#" + stepName + "commands").append("<a href='#' id='" + stepName + "Next' class='next readon'><span class='next'>" + options.nextBtnName + "</span></a>");
